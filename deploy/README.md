...
- update `ghcr.io/ylighgh/cloud-sd:v0.1.0` if you publish the image elsewhere
...
The default image is published by `.github/workflows/docker.yml`. Push a `v*` tag, or run the workflow manually with `image_tag=v0.1.0`, to publish `ghcr.io/ylighgh/cloud-sd:v0.1.0`.
