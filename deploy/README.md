...
- update `ghcr.io/ylighgh/prometheus-cloud-sd:v0.1.1` if you publish the image elsewhere
...
The default image is published by `.github/workflows/docker.yml`. Push a `v*` tag, or run the workflow manually with `image_tag=v0.1.1`, to publish `ghcr.io/ylighgh/prometheus-cloud-sd:v0.1.1`.
